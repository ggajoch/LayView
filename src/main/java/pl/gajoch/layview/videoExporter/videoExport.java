...
/*
 * $Id: videoExport.java,v 1.3 2007/07/06 20:45:31 jeffmc Exp $
 *
 ...
 * a QuickTime movie.
 */
public class videoExport implements ControllerListener,
        DataSinkListener {
    ...
    public static void createMovie(String movieFile, int width, int height,
        ...
        MediaLocator oml;
        if ((oml = videoExport.createMediaLocator(movieFile)) == null) {
            /*LogUtil.userErrorMessage("Cannot build media locator from: "
                    + movieFile);*/
            return;
        }
        videoExport imageToMovie = new videoExport();
    ...
    public static void main(String args[]) {
        ...
        //        System.err.println ("Running with new videoExport");
    ...
    static void prUsage() {
        System.err.println(
                "Usage: java videoExport -w <width> -h <height> -f <frame rate> -o <output URL> <input JPEG file 1> <input JPEG file 2> ...");
        System.exit(-1);
    }
